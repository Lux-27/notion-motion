...
const Header = () => {
  ...
  return (
    <header className="p-4 flex justify-center items-center">
      <Link
        href={"/"}
        className="w-full justify-left items-center flex gap-2"
      >
        <Image
          src={Logo}
          alt="CypressLogo"
            ...
            <NavigationMenuContent>
              <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                ...
                <ListItem
                  ...
                  title="Introduction"
                >
                  Re-usable components built using TailwindCSS
                </ListItem>
                <ListItem
                  href="#"
                  title="Installation"
                ...
                <ListItem
                  ...
                  title="Typography"
                >
                  Styles for heading, paragraphs, etc
                </ListItem>
              </ul>
            </NavigationMenuContent>
          </NavigationMenuItem>
            ...
            <NavigationMenuContent>
              <ul className="grid w-[400px] gap-3 p-4 md:grid-rows-2">
                <ListItem
                  ...
                  title="Pro Plan"
                >
                  Unlock full power with Collabs
                </ListItem>
                <ListItem
                  href="#"
                  title="Free Plan"
